...
$panels = array(
    'single_post_settings' => array('priority' => 99, 'title' => esc_html__("Impostazioni articolo", "wppa"), 'description' => esc_html__('Permette di cambiare le impostazioni dei singoli articoli','wppa'),'sections' => array()),
    'default' => array('sections' =>  array())
);

$panels['single_post_settings']['sections'] = array(
    'blog'              => array( esc_html__("Metadati", "wppa"), esc_html__( 'Imposta la visibilità dei metadati.', 'wppa' ), 1 ),
    'featured_image'    => array( esc_html__('Immagine in evidenza', 'wppa'), esc_html__( 'Impostazioni per la gestione dell\'immagine in evidenaa del singolo post', 'wppa' ), 2 ),
);


$panels['default']['sections'] = array(
    'social_links'              => array( esc_html__("Elenco dei social media", "wppa"), esc_html__( 'Inserisci l\'elenco dei link ai social media', 'wppa' ), 98 ),
...
foreach ( $panels as $panel_id => $panel ) {
    ...
    foreach ( $panel['sections'] as $section_id => $section ) {
        $section_args = array(
            ...
            'priority'    => $section[2],
            'panel'       => $panel_id=='default'?'':$k_panel_id
        );
        if ( isset( $section[3] ) ) {
...
my_config_kirki_add_field(
    array(
        ...
        'priority'    => 10,
        'choices'     => [
            '0' =>  get_template_directory_uri().'/assets/images/customizer/0.png', //'Disable Footer Widgets',
            '12'  => get_template_directory_uri().'/assets/images/customizer/12.png', //'1 Column',
            '6-6'  => get_template_directory_uri().'/assets/images/customizer/6-6.png', //'2 Columns: Equal Sizes',
            '4-8'  => get_template_directory_uri().'/assets/images/customizer/4-8.png', //'2 Columns: 4-8',
            '8-4'  => get_template_directory_uri().'/assets/images/customizer/8-4.png', //'2 Columns: 8-4',
            '4-4-4'  => get_template_directory_uri().'/assets/images/customizer/4-4-4.png', //'3 Columns: Equal Sizes',
            '6-3-3'  => get_template_directory_uri().'/assets/images/customizer/6-3-3.png', //'3 Columns: 6-3-3',
            '3-3-6'  => get_template_directory_uri().'/assets/images/customizer/3-3-6.png', //'3 Columns: 3-3-6',
            '3-4-5'  => get_template_directory_uri().'/assets/images/customizer/3-4-5.png', //'3 Columns: 3-4-5',
            '5-4-3'  => get_template_directory_uri().'/assets/images/customizer/5-4-3.png', //'3 Columns: 5-4-3',
            '3-3-3-3'  => get_template_directory_uri().'/assets/images/customizer/3-3-3-3.png', //'4 Columns: Equal Sizes',
...
?>
    <div class="form-field">
        <label for="icon_cat_id"><?php _e( 'Icona ID', '' ); ?></label>
        <input type="text" name="icon_cat_id" id="icon_cat_id" value="">
        <?php _e( 'Assegna una icona di Bootstrap Italia a questa cateogoria', '' ); ?>
    </div>
    <?php
}
...
?>
    <tr class="form-field">
        ...
        <td>
            <input type="text" name="icon_cat_id" id="icon_cat_id" value="<?php echo esc_attr( $icon_id ) ? esc_attr( $icon_id ) : ''; ?>">
            <?php _e( 'Assegna una icona di Bootstrap Italia a questa cateogoria','' ); ?>
        </td>
    </tr>
    <?php
...
function save_icon_cat_custom_meta( $term_id ) {
    if ( isset( $_POST['icon_cat_id'] ) ) {
        $term_meta = get_term_meta($term_id);
        // Save the taxonomy value.
        update_term_meta($term_id, 'icon_cat_id', $_POST['icon_cat_id']);
    }
}

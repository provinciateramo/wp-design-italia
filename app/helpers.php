...
function sage( $abstract = null, $parameters = [], Container $container = null ) {
	...
	return $container->bound( $abstract ) ? $container->makeWith( $abstract, $parameters ) : $container->makeWith( "sage.{$abstract}", $parameters );
}
...
function wppa_custom_pings( $comment ) {
	...
	?>
	<li
		<?php comment_class(); ?> id="li-comment-<?php esc_attr( comment_ID() ); ?>"><?php echo esc_attr( comment_author_link() ); ?></li>
	<?php
}

/**
 * Definisce la class css di larghezza in caso di sidebar o meno.
 *
 * @return string
 */
...
/**
 * Resistituisce la sidebar da visualizzare.
 *
 * @return mixed|string
 */
...
/**
 * Resistituisce il testo di colophon.
 *
 * @return void
 */
function wp_footer_colophon() {
	...
	if ( '' === get_theme_mod( 'footer_text' ) ) {
		?>
		// translators:
		<?php echo esc_html( sprintf( __( '%1$s %2$s %3$s', 'wppa' ), '&copy;', date( 'Y' ), esc_html( get_bloginfo( 'name' ) ) ) ); ?>
		<?php
	} else {
...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		 ...
		 *
		 * @return string return fallback text.
		 */

<header id="mainheader" class="it-header-wrapper it-header-sticky fixed-top-section-disabled" role="banner">
  ...
  <div class="it-nav-wrapper">
    ...
    <div class="it-header-navbar-wrapper">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <nav class="navbar navbar-expand-lg" id="menu-main-bar" role="navigation">
				  <button aria-controls="nav10" aria-expanded="false"
						  aria-label="Toggle navigation" class="custom-navbar-toggler"
						  data-target="#nav10" type="button">
					  <svg class="icon">
						  <use xlink:href="{{ \App\asset_path('bootstrap-italia/svg/sprite.svg') }}#it-burger"></use>
					  </svg>
				  </button>

...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style( 'bootstrap-italia-min', asset_path("bootstrap-italia/css/bootstrap-italia.min.css"));
    wp_enqueue_style( 'bootstrap-italia-map', asset_path("bootstrap-italia/css/bootstrap-italia.min.css.map"));
    //wp_enqueue_style( 'italia-icon-font', asset_path("bootstrap-italia/css/italia-icon-font.css"));
    wp_enqueue_style('sage/main.css', asset_path('styles/main.css'), false, null);

    wp_enqueue_script('sage/main.js', asset_path('scripts/main.js'), ['jquery'], null, true);
    wp_enqueue_script( 'bootstrap-italia-bundle-min', asset_path('bootstrap-italia/js/bootstrap-italia.bundle.min.js'), array(), true, true );
